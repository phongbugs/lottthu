...
const messages = {
  es: {
    ...
    // for lottery
    lottery: "Xổ số",
    historyDrawOption: "Tùy chọn lịch sử",
    drawHistory: "Lịch sử quay",
    historyDrawByPeriod: "Kỳ quay",
    historyDrawByDate: "Ngày tháng",
    datePickerStartPlaceholder: "Ngày bắt đầu",
    datePickerEndPlaceholder: "Ngày kết thúc",
  ...
  en: {
    ...
    // for lottery
    lottery: "lottery",
    historyDrawOption: "History draw option",
    drawHistory: "Draw history",
    historyDrawByPeriod: "Draw period",
    historyDrawByDate: "Draw date",
    datePickerStartPlaceholder: "Start date",
    datePickerEndPlaceholder: "End date",
    datePickerRangeSeparator: "to",
    lastestDrawPeriods: "Fill quantity of lastest draw periods",
  ...
  vi: {
    ...
    historyDrawByPeriod: "Kỳ quay",
    historyDrawByDate: "Ngày tháng",
    datePickerStartPlaceholder: "Từ ngày",
    datePickerEndPlaceholder: "Đến ngày",
    datePickerRangeSeparator: "đến",
    lastestDrawPeriods: "Tùy chọn số lượng kỳ quay gần nhất",
